...
단건 태스크뿐 아니라 **장기 목표도 맡길 수 있습니다.**
*"MAU 10만 달성해줘"* 한마디면 OKR로 자동 분해되고,
일일회고 → 주간점검 → 월간리뷰 → 분기평가까지 **경영 사이클이 자동으로 돌아갑니다.**
성과평가 결과는 봇 성격에 반영되어, 일 잘하는 봇은 점점 더 잘하게 됩니다.

<p align="center">
  <img src="assets/diagrams/feat_okr_system.png" alt="OKR 목표 관리 시스템 — Objective→KR→Initiative→Task 계층 + 리뷰 사이클 + 성과평가" width="700"/>
</p>
