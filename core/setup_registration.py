...
DEFAULT_ORCHESTRATION_CONFIG: dict[str, Any] = {
    ...
    "team_profiles": {
        "global_orchestrator": {
            ...
            "preferred_skills": ["pm-task-dispatch", "pm-discussion", "weekly-review", "retro", "performance-eval"],
            "avoid_agents": [],
            "max_team_size": 3,
        ...
        "research_strategy": {
            ...
            "preferred_skills": ["growth-analysis"],
            "avoid_agents": [],
            "max_team_size": 3,
        ...
        "engineering_delivery": {
            ...
            "preferred_skills": ["engineering-review"],
            "avoid_agents": [],
            "max_team_size": 3,
        ...
        "design_strategy": {
            ...
            "preferred_skills": ["design-critique", "brainstorming-auto"],
            "avoid_agents": [],
            "max_team_size": 3,
        ...
        "product_strategy": {
            ...
            "preferred_skills": ["brainstorming-auto"],
            "avoid_agents": [],
            "max_team_size": 3,
        ...
        "ops_delivery": {
            ...
            "preferred_skills": ["harness-audit"],
            "avoid_agents": [],
            "max_team_size": 3,
